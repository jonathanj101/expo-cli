  ...
  handleConnectivityChange = connectionInfo => {
    ...
    switch (connectionInfo.type) {
      ...
      case 'cellular':
        ...
        break;
      case 'wifi':
        connectionMsg = 'You are now connected to a WI-FI network.';
        break;
    }
    (Platform.OS === 'iso') ? Alert.alert('Connection change:', connectionMsg) : ToastAndrod.show(connectionMsg, ToastAndroid.LONG);
  };
